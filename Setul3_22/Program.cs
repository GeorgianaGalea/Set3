...
namespace Setul3_22
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Introduceti elementele primului vector separate prin spatii:");
            int[] v1 = CitesteVector();
            Console.WriteLine("Introduceti elementele celui de-al doilea vector separate prin spatii:");
